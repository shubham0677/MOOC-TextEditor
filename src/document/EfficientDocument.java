...
public class EfficientDocument extends Document {
	...
	private void processText()
	{
		...
		for(String token : tokens) {
			...
			if(isWord(token)) {
				...
				if(token.equals(last)) { numSentences++; }
	...
	public int getNumSentences() {
		//List<String> tokensSent =this.getTokens("[a-zA-Z0-9,(): ]+[.!?|a-z]+");
		//return tokensSent.size();
	...
	public int getNumWords() {
		//List<String> tokensWord =this.getTokens("[a-zA-Z]+");
